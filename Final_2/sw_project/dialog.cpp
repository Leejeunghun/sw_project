...
static int betting_1=1;
static int betting_2=1;
static int PLAYER_COIN_1=20;
static int PLAYER_COIN_2=20;
static int random_count=0;
static int player_1_card[10]={};
static int player_2_card[10]={};
static int player =1;
...
void Dialog::on_pushButton_Raise_clicked()  //"Raise button"
{
    if(player==1)    //player 1
    {
     if(PLAYER_COIN_1 >betting_1)
     {
        betting_1=betting_1+1; //If clicked button, coin raise
     }
     else
     {
